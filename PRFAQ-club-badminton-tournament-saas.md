...
* Tự động sắp thứ tự trận theo số sân
* Nhập điểm trận đấu cực nhanh ngay tại sân
...
* Khó quản lý thứ tự trận theo số sân
* Regenerate bracket rất cực
...
1. Tạo giải
2. Tạo các nội dung thi đấu đôi (Đôi TB, Đôi TBY)
3. Nhập danh sách các đôi theo nội dung thi đấu. Nếu giải nội bộ thì không cần tên clb, giải mở rộng thì cần tên clb.
4. Random / manual seeding
5. Generate bracket type: Group (round robin) → Knockout
6. Regenerate bracket khi cần
7. Nhập điểm trận nhanh trên sân, có thể tùy chỉnh điểm số bằng tay.
8. Tự động cập nhật bracket
9. Share link public theo dõi giải
